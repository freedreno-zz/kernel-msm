			       ...
			       enum nl80211_iftype type)
{
	...
	/* Enlarge the Beacon miss threshold from 1.5s to 5s.  Bueller is
	actively using BluetoothDiscovery to find Hurley and several Beacon
	miss is seen.  Hence increase the threshold.*/
