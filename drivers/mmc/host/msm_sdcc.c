...
#define MSM_MMC_DEFAULT_CPUDMA_LATENCY 200 /* usecs */
	...
	/*
	 * Disabling packed write as some flash cards are not able to handle
	 * it and CMD25 multiple block write timeouts are observed.  The
	 * performance with and without packed write are similar and no
	 * performance hit is observed.
	 */
