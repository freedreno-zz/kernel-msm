...
static void hdmi_bridge_dpms(struct drm_bridge *bridge, int mode)
{
	struct hdmi_bridge *hdmi_bridge = to_hdmi_bridge(bridge);
	...
	if (enabled == hdmi_bridge->enabled)
		return;
...
static const struct drm_bridge_helper_funcs hdmi_bridge_helper_funcs = {
		.dpms = hdmi_bridge_dpms,
...
struct drm_bridge *hdmi_bridge_init(struct hdmi *hdmi)
{
	...
	drm_bridge_helper_add(bridge, &hdmi_bridge_helper_funcs);
