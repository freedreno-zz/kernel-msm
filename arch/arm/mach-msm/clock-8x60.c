...
static struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_LOOKUP("byte_clk",	dsi_byte_clk.c,		"mipi_dsi.0"),
	CLK_LOOKUP("esc_clk",	dsi_esc_clk.c,		"mipi_dsi.0"),
	...
	CLK_LOOKUP("master_iface_clk",	dsi_m_p_clk.c,		"mipi_dsi.0"),
	CLK_LOOKUP("slave_iface_clk",	dsi_s_p_clk.c,		"mipi_dsi.0"),
