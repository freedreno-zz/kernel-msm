...
static struct clk_lookup msm_clocks_8064[] = {
	...
	CLK_LOOKUP("byte_clk",	dsi1_byte_clk.c,	"mipi_dsi.0"),
	CLK_LOOKUP("byte_clk",	dsi2_byte_clk.c,	"mipi_dsi.2"),
	CLK_LOOKUP("esc_clk",	dsi1_esc_clk.c,		"mipi_dsi.0"),
	...
	CLK_LOOKUP("arb_clk",		amp_p_clk.c,		"mipi_dsi.0"),
	...
	CLK_LOOKUP("master_iface_clk",	dsi1_m_p_clk.c,		"mipi_dsi.0"),
	CLK_LOOKUP("slave_iface_clk",	dsi1_s_p_clk.c,		"mipi_dsi.0"),
